...
{
    @Autowired //Tells spring boot to make one of these automatically and stuff it in all SubscriberController objects.
    private SubscriberRepository subscriberRepository;
    
    //This specifies that an HTTP (web) Get request to the path "/" should invoke this function.
    @GetMapping(value="/")
    public String index(Subscriber subscriber)
    {

        //This is the method we want to call when the main web page is visited.
        return "subscriber/index"; //This is the location of a Thymeleaf template we will create. (ending .html not necessary)
    }
